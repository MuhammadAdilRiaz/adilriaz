...
import bannerImage from 'assets/UIUX-Designs.png';
  ...
  return (
    <Box as="section" id="banner" sx={styles.banner}>
      <Container sx={styles.container}>
        ...
        <Heading as="h2">I'm Muhammad Adil Riaz</Heading>
        <Heading as="h3">Freelancer, multi_xpert</Heading>
        <Heading as="h3">UX/UI Designer & Front End Developer</Heading>
